...
async function loadRating() {
    ...
    if (!data || data.length === 0) {
        document.getElementById('ratingList').innerHTML = '<div style="color: #64748b;">Нет данных</div>';
        return;
    }
            ...
            <div class="member">
                <div class="member-left">
                    ...
                    <div>
                        ...
                        <div style="font-size: 11px; color: #64748b;">${statusIcon} ${user.status || '—'}</div>
                    </div>
                </div>
                <div>${hours}ч</div>
            </div>
...
async function loadMessages() {
    ...
    if (!data || data.length === 0) {
        container.innerHTML = '<div style="text-align: center; color: #64748b;">💬 Нет сообщений</div>';
        return;
    }
